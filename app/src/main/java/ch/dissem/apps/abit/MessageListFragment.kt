    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.eventListener = object : SwipeableMessageAdapter.EventListener {
            ...
            override fun onItemViewClicked(v: View?) {
                val position = v?.let { view.findViewById<RecyclerView>(R.id.recycler_view).getChildAdapterPosition(it) }
                if (position != null) {
                    adapter.setSelectedPosition(position)
                }
                if (position != RecyclerView.NO_POSITION) {
                    val item = position?.let { adapter.getItem(it) }
                    if (item != null) {
        ...
        view.findViewById<RecyclerView>(R.id.recycler_view).adapter = wrappedAdapter  // requires *wrapped* swipeableMessageAdapter
        view.findViewById<RecyclerView>(R.id.recycler_view).itemAnimator = animator
        view.findViewById<RecyclerView>(R.id.recycler_view).addOnScrollListener(recyclerViewOnScrollListener)

        view.findViewById<RecyclerView>(R.id.recycler_view).addItemDecoration(SimpleListDividerDecorator(
        ...
        touchActionGuardManager.attachRecyclerView(view.findViewById<RecyclerView>(R.id.recycler_view))
        swipeManager.attachRecyclerView(view.findViewById<RecyclerView>(R.id.recycler_view))
